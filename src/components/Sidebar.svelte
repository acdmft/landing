<div
  class="absolute left-0 top-1/3 w-10 h-30 flex flex-col items-center py-2 border rounded-r-md border-slate-400"
>
  <!-- GitHub LOGO -->
  ...
  <!-- Linkedin LOGO -->
  <a href="https://www.linkedin.com/in/andrei-zheksim/" class="mt-3">
    <img src="linkedin.png" alt="linkedin" />
  </a>
  <!-- CODEWARS LOGO -->
  <a href="https://www.codewars.com/users/acdmft" class="mt-3">
